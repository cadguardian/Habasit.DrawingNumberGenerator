...
public class BeltSeriesService : IBeltSeriesService
{
    private readonly ILogger<BeltSeriesService> _logger;

    public BeltSeriesService(ILogger<BeltSeriesService> logger)
    {
        _logger = logger;
    }
